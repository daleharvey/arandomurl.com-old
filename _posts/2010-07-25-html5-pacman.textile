...
function supportsOggAudio() {
  ...
  return typeof myAudio.canPlayType === "function" && 
    ...
    if (supports_canvas() && supports_local_storage() && supportsOggAudio()) {
      window.setTimeout(function () { PACMAN.init(el, "/random/pacman/"); }, 0);
    } else { 
      el.innerHTML = "Sorry, needs a decent browser<br /><small>" + 
        "(firefox 3.6+, Chrome 4+, Opera 10+ and <strike>probably Safari<strike>)</small>";
    }
</script>
...
<script type="text/javascript">
	var flattr_url = 'http://arandomurl.com/2010/07/25/html5-pacman.html';
