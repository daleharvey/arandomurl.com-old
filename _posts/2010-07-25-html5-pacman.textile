...
If your audio works locally, but not from a server, remember to configure your server to serve media files with the correct media types. I had to add this to <code>/etc/nginx/mime.types</code>
<pre>
video/ogg                             ogg;
audio/wav                             wav;
font/ttf                              ttf;
