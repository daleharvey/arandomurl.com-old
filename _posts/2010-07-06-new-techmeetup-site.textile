...
The old techmeetup site was WordPress based, WordPress is designed to be an easy to set up blogging platform for those that couldn't (or didn't want to) write their own and it fills that role well.
